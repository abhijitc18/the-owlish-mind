        ...
        <div class="row no-gutters">
            ...
            <div class="col-md-7 wrap-about py-4 py-md-5 ftco-animate">
                ...
                <div class="pl-md-5 ml-md-5 mb-5">
                    <p>
                        Founded in 2019, The Owlish Mind is committed to promoting mental well-being for individuals
                        across all age groups. We provide confidential, personalized, and evidence-based psychological
                        services, including psychotherapy, psycho-diagnostic assessments, career counselling, and mental
                        health interventions.
                    </p>
                    <p>
                        To make mental health support accessible and inclusive, we collaborate with multi-specialty
                        clinics, educational institutions, and corporate organizations. Our specialized student programs
                        address learning difficulties, behaviour modification, and cognitive development through
                        structured interventions.
                    </p>
                    <p>
                        At The Owlish Mind, we strive to create a safe, professional, and supportive environment where
                        individuals can achieve emotional clarity, resilience, and personal growth.
                    </p>
