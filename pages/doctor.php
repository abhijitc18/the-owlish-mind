        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="staff">
                    <div class="img-wrap d-flex align-items-stretch">
                        <div class="img align-self-stretch"
                            style="background-image: url(/theowlishmind/assets/images/doc-3.jpg);">
                        </div>
                    </div>
                    <div class="text pt-3 text-center">
                        <h3>Dr. Ian Smith</h3>
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="staff">
                    <div class="img-wrap d-flex align-items-stretch">
                        <div class="img align-self-stretch"
                            style="background-image: url(/theowlishmind/assets/images/doc-4.jpg);">
                        </div>
                    </div>
                    <div class="text pt-3 text-center">
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="staff">
                    <div class="img-wrap d-flex align-items-stretch">
                        <div class="img align-self-stretch"
                            style="background-image: url(/theowlishmind/assets/images/doc-5.jpg);">
                        </div>
                    </div>
                    <div class="text pt-3 text-center">
                        <h3>Dr. Lloyd Wilson</h3>
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="staff">
                    <div class="img-wrap d-flex align-items-stretch">
                        <div class="img align-self-stretch"
                            style="background-image: url(/theowlishmind/assets/images/doc-6.jpg);">
                        </div>
                    </div>
                    <div class="text pt-3 text-center">
                        <h3>Dr. Rachel Parker</h3>
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="staff">
                    <div class="img-wrap d-flex align-items-stretch">
                        <div class="img align-self-stretch"
                            style="background-image: url(/theowlishmind/assets/images/doc-7.jpg);">
                        </div>
                    </div>
                    <div class="text pt-3 text-center">
                        <h3>Dr. Ian Smith</h3>
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="staff">
                    <div class="img-wrap d-flex align-items-stretch">
                        <div class="img align-self-stretch"
                            style="background-image: url(/theowlishmind/assets/images/doc-8.jpg);">
                        </div>
                    </div>
                    <div class="text pt-3 text-center">
                        <h3>Dr. Alicia Henderson</h3>
